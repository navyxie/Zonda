...
define("#util/0.1.0/route/route-debug", ["#jquery/1.8.2/jquery-debug", "#underscore/1.4.2/underscore-debug"], function ( require, exports, module) {
...
define("#util/0.1.0/cookie/cookie-debug", [], function ( require, exports, module ) {
...
define("#util/0.1.0/gif/gif-debug", ["#jquery/1.8.2/jquery-debug"], function( require, exports, module) {
    var $ = require('#jquery/1.8.2/jquery-debug');
...
define("#util/0.1.0/dialog/dialog-debug", ["#bootstrap/2.1.1/bootstrap-debug", "#jquery/1.8.2/jquery-debug", "#underscore/1.4.2/underscore-debug"], function( require, exports, module ){
    var $ = require('#bootstrap/2.1.1/bootstrap-debug');
    var _ = require('#underscore/1.4.2/underscore-debug');

    // 准备模板
    var dialogTPL = '<div class="modal hide fade" id="util-dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button><h3 id="myModalLabel"><%= title %></h3></div><div class="modal-body"><%= content %></div><div class="modal-footer"><button class="btn" data-dismiss="modal" aria-hidden="true">取消</button></div></div>';
...
define("#util/0.1.0/verify/verification-debug", ["#underscore/1.4.2/underscore-debug", "#jquery/1.8.2/jquery-debug"], function ( require, exports, module ) {
    // 加载Underscore模块
    var _ = require('#underscore/1.4.2/underscore-debug');
...
define("#util/0.1.0/verify/verify-debug", ["./verification-debug", "#underscore/1.4.2/underscore-debug", "#jquery/1.8.2/jquery-debug"], function ( require, exports, module ) {
...
define("#util/0.1.0/stateMachine/stateMachine-debug", ["#jquery/1.8.2/jquery-debug"], function ( require, exports, module) {
    var $ = require('#jquery/1.8.2/jquery-debug');
...
define("#util/0.1.0/rightClickMenu/rightClickMenu-debug", ["#bootstrap/2.1.1/bootstrap-debug", "#jquery/1.8.2/jquery-debug", "#underscore/1.4.2/underscore-debug"], function( require, exports, module ){
    var $ = require('#bootstrap/2.1.1/bootstrap-debug');
    var _ = require('#underscore/1.4.2/underscore-debug');
...
define("#util/0.1.0/ajax/ajax-debug", ["../dialog/dialog-debug", "#jquery/1.8.2/jquery-debug", "#bootstrap/2.1.1/bootstrap-debug", "#underscore/1.4.2/underscore-debug"], function( require, exports, module ) {
    var $ = require('#jquery/1.8.2/jquery-debug');
 ...
 *
 */
define("#util/0.1.0/slide/slide-debug", ["#underscore/1.4.2/underscore-debug", "#jquery/1.8.2/jquery-debug"], function ( require, exports, module ) {
    var _ = require('#underscore/1.4.2/underscore-debug');
    var $ = require('#jquery/1.8.2/jquery-debug');
...
define("#util/0.1.0/tips/tips-debug", [], function ( require, exports, module ) {
 ...
 *
 */
define("#util/0.1.0/scaffold/scaffold-debug", ["#jquery/1.8.2/jquery-debug"], function ( require, exports, module ) {
    var $ = require('#jquery/1.8.2/jquery-debug');
...
define("#util/0.1.0/upload/upload-debug", ["#underscore/1.4.2/underscore-debug", "#jquery/1.8.2/jquery-debug", "#backbone/0.9.2/backbone-debug"], function( require, exports, module ) {
    // 加载 Underscore 模块
    var _ = require('#underscore/1.4.2/underscore-debug');
 ...
 * 框架组件
 */
define("#util/0.1.0/util-debug", ["./route/route-debug", "./cookie/cookie-debug", "./gif/gif-debug", "./dialog/dialog-debug", "./verify/verification-debug", "./verify/verify-debug", "./stateMachine/stateMachine-debug", "./rightClickMenu/rightClickMenu-debug", "./ajax/ajax-debug", "./slide/slide-debug", "./tips/tips-debug", "./scaffold/scaffold-debug", "./upload/upload-debug", "#jquery/1.8.2/jquery-debug", "#underscore/1.4.2/underscore-debug", "#bootstrap/2.1.1/bootstrap-debug", "#backbone/0.9.2/backbone-debug"], function(require, exports, module){
